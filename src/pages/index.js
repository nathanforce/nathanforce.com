...
const IndexPage = () => (
  <Layout>
    <RandomGradient
      render={({ left, right }) => (
        <div className="p2 max-width-3  mx-auto">
          <div
            style={{
          ...
          <div className="left-align mt2 max-width-3">
            <h1 className="mb1 mt2">Nathan Force</h1>
            <p className="mt1">
              Hello! I am a Javascript developer in Brooklyn, NY working to
              write clean code and create simple, usable web experiences. Give
              me a shout at{' '}
              <a
