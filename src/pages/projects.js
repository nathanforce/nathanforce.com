    ...
    console.log(data) || (
        <div className="md-px4 px2 pt0">
            ...
            <div className="max-width-3 mx-auto center">
                Below are some of the projects I've worked on in the past or
                actively work on now. Unfortunately, most of my current work is
                closed off behind the Corporate Veil of Secrecy™.
            </div>
